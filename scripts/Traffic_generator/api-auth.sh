...
curl -k --silent --output /dev/null --location 'https://'$1'/api/adjectives' --header 'Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6IjAwMDEifQ.eyJhdWQiOiJ3d3cuZXhhbXBsZS5jb20iLCJzdWIiOiJqcm9ja2V0QGV4YW1wbGUuY29tIiwiRmlyc3QgTmFtZSI6IkpvaG4iLCJMYXN0IE5hbWUiOiJTbWl0aCIsIkVtYWlsIjoiam9obkBzcG9uZ2UuY29tIiwiUm9sZSI6WyJNYW5hZ2VyIiwiUHJvamVjdCBBZG1pbmlzdHJhdG9yIl19._6k763PnKx-DuAn1h-EpRTJRcdaUjB5FNCn7OTtz7yg' --header 'Cookie: _imp_apg_r_='$DID'' --header 'xff: '$IP'' --header 'Content-Type: application/json';
